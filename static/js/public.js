...
var travelTemplateData = { //旅行记模版
  ...
  bbs1: '<div class="time_pu "><div class="bbsClass drapBox template01 template_lxj_2"><div class="drap_img"></div><img imgSort="1" typeStyle="1" class="img_drap" src=""/></div><div  class="page"><div class="pageleft">第<span></span>页</div><div class="pageRight"></div></div></div>',
  bbs2: '<div class="time_pu "><div class="bbsClass drapBox template02 template_lxj_3"><div class="drap_img"></div><img  class="img_drap" imgSort="1" typeStyle="2" src=""/></div><div  class="page"><div class="pageleft">第<span></span>页</div><div class="pageRight"></div></div></div>',
  bbs3: '<div class="time_pu "><div class="bbsClass drapBox template05 template_lxj_4"><div class="drap_img"></div><img class="img_drap" imgSort="1" typeStyle="5" src=""/></div><div maxlength="40" textSort="1" typeStyle="5"  class="text title_pu"><span class="text_span text_40"></span></div><div  class="page"><div class="pageleft">第<span></span>页</div><div class="pageRight"></div></div></div>',
  ...
  bbs5: '<div class="time_pu "><div class="bbsClass template06 template_lxj_6"><div class="drapBox div_page"><div class="drap_img"></div><img class="img_drap" imgSort="1" typeStyle="6" src=""/></div><div class="drapBox div_page"><div class="drap_img"></div><img class="img_drap" imgSort="2" typeStyle="6" src=""/></div></div><div maxlength="40" textSort="1" typeStyle="6" class="text title_pu"><span class="text_span text_40"></span></div><div  class="page"><div class="pageleft">第<span></span>页</div><div class="pageRight"></div></div></div>',

  // bbs4: '<div class="time_pu "><div class="drapBox bbsClass template04"><div class="drap_img"></div><img class="img_drap" imgSort="1" typeStyle="4" src=""/></div><div style="visibility: hidden;" maxlength="40" textSort="1" typeStyle="4" class="text title_pu"><span class="text_span text_40"></span></div style><div  class="page"><div class="pageleft">第<span></span>页</div><div class="pageRight"></div></div></div>',
  bbs6: '<div class="time_pu "><div class="bbsClass template03"><div class="drapBox div_page"><div class="drap_img"></div><img class="img_drap" imgSort="1" typeStyle="3" src=""/></div><div class="drapBox div_page"><div class="drap_img"></div><img class="img_drap" imgSort="2" typeStyle="3" src=""/></div></div><div maxlength="40" textSort="1" typeStyle="3" class="text title_pu"><span class="text_span text_40"></span></div><div  class="page"><div class="pageleft">第<span></span>页</div><div class="pageRight"></div></div></div>',
